export const M_THUMBNAIL = "Thumbnails/thumbnail.png";
export const M_RESOURCES = "resources";
export const M_FILE_ENTRIES = "file-entries";
export const M_FIle_ENTRY = "file-entry";
export const M_FULL_PATH = "full-path";
export const M_PASSWORD_HINT = "password-hint";
export const M_ENCRYPTION_DATA = "encryption-data";
export const M_CHECKSUM = "checksum";
export const M_CHECKSUM_TYPE = "checksum-type";
export const M_ITERATION_COUNT = "iteration-count";
export const M_ALGORITHM = "algorithm";
export const M_ALGORITHM_NAME = "algorithm-name";
export const M_KEY_DERIVATION = "key-derivation";
export const M_KEY_DERIVATION_NAME = "key-derivation-name";
export const M_SALT = "salt";
export const M_IV = "iv";
export const M_KEY_SIZE = "size";
export const ZEN_PATH_MANIFEST = "manifest.json";
export const ZEN_PATH_METADATA = "metadata.json";
export const ZEN_PATH_CONTENT = "content.json";
export const ZEN_PATH_CONTENT_FOR_OLD_XMIND_VERSION = "content.xml";
export const MANIFEST_STRUCTURAL = {
  [M_FILE_ENTRIES]: {
    [ZEN_PATH_CONTENT]: {},
    [ZEN_PATH_METADATA]: {},
  },
...
export const ZEN_PATH_MANIFEST_S = "/manifest.json";
export const ZEN_PATH_METADATA_S = "/metadata.json";
export const ZEN_PATH_CONTENT_S = "/content.json";
export const XMIND_PATH_MANIFEST = "META-INF/manifest.xml";
export const XMIND_PATH_CONTENT = "content.xml";
export const XMIND_PATH_STYLES = "styles.xml";
export const XMIND_PATH_COMMNETS = "comments.xml";
export const XMIND_PATH_MARKERS = "markers/markerSheet.xml";
export const XMIND_PATH_THUMBNAIL = "Thumbnails/thumbnail.png";
export const XMIND_PATH_META = "meta.xml";
export const XMIND_PATH_MANIFEST_S = "/META-INF/manifest.xml";
export const XMIND_PATH_CONTENT_S = "/content.xml";
export const XMIND_PATH_STYLES_S = "/styles.xml";
export const XMIND_PATH_COMMNETS_S = "/comments.xml";
export const XMIND_PATH_MARKERS_S = "/markers/markerSheet.xml";
export const XMIND_PATH_THUMBNAIL_S = "/Thumbnails/thumbnail.png";
export const OLD_XMIND_CONTENT_IN_ZEN = `<?xml version="1.0" encoding="UTF-8" standalone="no"?><xmap-content xmlns="urn:xmind:xmap:xmlns:content:2.0" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink" modified-by="bruce" timestamp="1503058545540" version="2.0"><sheet id="7abtd0ssc7n4pi1nu6i7b6lsdh" modified-by="bruce" theme="0kdeemiijde6nuk97e4t0vpp54" timestamp="1503058545540"><topic id="1vr0lcte2og4t2sopiogvdmifc" modified-by="bruce" structure-class="org.xmind.ui.logic.right" timestamp="1503058545417"><title>Warning
警告
Attention
Warnung
...
export const FLOAT_X_COORDINATE_INCREASE = 0;
export const FLOAT_Y_COORDINATE_INCREASE = 150;
// textbundle
export const TEXT_BUNDLE_ASSETS = "assets/";
export const TEXT_BUNDLE_CONTENT = "text.md";
export const TEXT_BUNDLE_INFO = "info.json";
