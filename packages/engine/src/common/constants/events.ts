...
export const EVENTS = {
  ...
  AFTER_ADD_EXISTING_SHEET: 'afterAddExistingSheet',
  // necessary params: { target: Model, attr: String }
  ...
  COMPACT_LAYOUT_MODE_LEVEL_CHANGED: 'COMPACT_LAYOUT_MODE_LEVEL_CHANGED',
  ALIGNMENT_BY_LEVEL_STATUS_CHANGED: 'ALIGNMENT_BY_LEVEL_STATUS_CHANGED',
  HAND_DRAWN_MODE_ACTIVE_CHANGED: 'HAND_DRAWN_MODE_ACTIVE_CHANGED',
  ACTIVED_GLOBAL_STYLES_CHANGED: 'ACTIVED_GLOBAL_STYLES_CHANGED',
} as const;
