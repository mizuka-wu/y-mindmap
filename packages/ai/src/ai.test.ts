...
function createTestState(doc: RootTopic): EditorState {
  ...
  return EditorState.create(workbook);
}

function createTestDocument(): RootTopic {
...
describe("SuggestionEngine", () => {
  ...
  it("should have valid suggestion structure", () => {
    ...
    for (const suggestion of suggestions) {
      ...
      expect(["structure", "content", "organization", "style"]).toContain(
        suggestion.category,
      );
    }
  });
